...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            tauri_commands::autopilot::autopilot_disengage,
            tauri_commands::voice::voice_list_devices,
            tauri_commands::voice::voice_wake_ready,
            tauri_commands::voice::voice_download_kws,
            tauri_commands::voice::voice_enable,
            tauri_commands::voice::voice_disable,
            tauri_commands::voice::voice_tts_ready,
            tauri_commands::voice::voice_download_tts,
            tauri_commands::voice::voice_speak,
            tauri_commands::autopilot::autopilot_get_defaults,
            tauri_commands::autopilot::autopilot_set_defaults,
            tauri_commands::mobile::mobile_takeover_start,
            tauri_commands::mobile::mobile_takeover_stop,
            tauri_commands::mobile::mobile_takeover_status,
            tauri_commands::mobile::mobile_takeover_force_release,
            ...
            tauri_commands::git::git_branch_list,
            tauri_commands::git::git_branch_rename,
            tauri_commands::git::git_branch_delete_remote,
            tauri_commands::git::git_checkout_remote,
            tauri_commands::git::git_push_delete,
            tauri_commands::git::git_merge,
            tauri_commands::git::git_merge_abort,
            tauri_commands::git::git_rebase,
            tauri_commands::git::git_rebase_continue,
            tauri_commands::git::git_rebase_abort,
